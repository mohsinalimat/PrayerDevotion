...
class PrayerLocationsViewController_old: UIViewController, CLLocationManagerDelegate, GMSMapViewDelegate {
    ...
    func presentUnauthorizedAlert() {
        let alert = UIAlertController(title: "Error", message: "In order to use the prayer locations feature of the application, you must allow this application to use your current location.", preferredStyle: .Alert)
