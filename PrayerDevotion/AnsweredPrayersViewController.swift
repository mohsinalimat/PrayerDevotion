...
class AnsweredPrayersViewController: UITableViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        var sortDescriptors = [NSSortDescriptor(key: "answeredTimestamp", ascending: false)]
    ...
    override func tableView(tableView: UITableView, editActionsForRowAtIndexPath indexPath: NSIndexPath) -> [AnyObject]? {
        var deleteAction = UITableViewRowAction(style: .Default, title: "Delete", handler: { rowAction, indexPath in
